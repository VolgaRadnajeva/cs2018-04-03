package by.it.demologin.lesson03;
...
class TaskA2 {
    public static void main(String[] args) {
        ...
        System.out.println("jhgfdfdgfbfhfdgfddsfdsgsds fsdfs fsd fs s");
        System.out.println("jhgfdfdgfgfgfdfgddsfdsgsds fsdfs fsd fs s");
        System.out.println("jhgfdfddfgdfgfgfddsfdsgsds fsdfs fsd fs s");
        System.out.println("jhgfdfdgfgfdgdfddsfdsgsds fsdfs fsd fs s");
    }
