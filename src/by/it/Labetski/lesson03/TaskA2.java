...
class TaskA2 {
    public static void main(String[] args) {
        ...
        String a = "Я волком бы выгрыз бюрократизм.";
        String b = "К мандатам почтения нету.";
        String c = "К любым чертям с матерями катись любая бумажка.";
        String d = "Я достаю из широких штанин дубликатом бесценного груза.";
        String e = "Читайте, завидуйте, я - гражданин Советского Союза.";
