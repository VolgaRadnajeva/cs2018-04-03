...
public class TaskC1 {
    public static void main(String[] args) {
        ...
        Dog d1 = new Dog(scanner.next(), scanner.nextInt(), scanner.nextInt(), scanner.nextDouble());
        Dog d2 = new Dog(scanner.next(), scanner.nextInt(), scanner.nextInt(), scanner.nextDouble());
